...
export const metadata: Metadata = {
  title: "ChapterFlash™ EMT - ProMedixEMS™",
  ...
  applicationName: "ChapterFlash™ EMT",
  category: "Education",
  ...
  openGraph: {
    type: "website",
    siteName: "ChapterFlash™ EMT - ProMedixEMS™",
    title: "ChapterFlash™ EMT - Master EMT Certification",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ChapterFlash™ EMT - Professional EMT Study Application"
      }
    ]
  },
  twitter: {
