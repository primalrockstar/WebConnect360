      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/about" className="hover:text-primary transition-colors">About ChapterFlash</Link></li>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-amber-200/90 leading-relaxed">
                  <strong>ChapterFlash™ is an independent EMS education tool</strong> and is not 
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <div className="text-center md:text-left">
            <p>© 2025 ChapterFlash. All rights reserved.</p>
        ...
        <div className="mt-6 pt-6 border-t border-white/10">
          <p className="text-xs text-center text-muted-foreground/80 leading-relaxed max-w-4xl mx-auto">
            <strong>Professional Standards:</strong> ChapterFlash adheres to the highest standards 
